...
public final class Consts {
    ...
    public static final Integer LOWEST_COSTING_UPGRADE = 100;
    public static final Integer SAVE_FOR_UPGRADES = 500;
    ...
    public static final String A_WALK_IN_THE_PARK = "Walk in the park";
    public static final String PIECE_OF_CAKE = "Piece of cake";
    public static final String SURE_THING = "Sure thing";

    // Game
    static final String URI = "https://www.dragonsofmugloar.com/api/v2/";
